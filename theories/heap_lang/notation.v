...
Notation strindex e1 e2 e3 := (TernOp IndexOp e1 e2 e3).
Notation strsub e1 e2 e3 := (TernOp SubOp e1 e2 e3).
Notation z2s e := (UnOp StringOfIntOp e).
Notation s2z e := (UnOp IntOfStringOp e).
Notation strlen e := (UnOp LengthOp e).
...
Notation "e1 ^ e2" := (BinOp AppendOp e1%E e2%E) : expr_scope.
