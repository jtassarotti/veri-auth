...
Ltac reshape_expr e tac :=
  ...
  let rec go K vs e :=
    ...
    | TernOp ?op ?e (Val ?v2) (Val ?v3) => add_item (TernOp1Ctx op v2 v3) vs K e
    | TernOp ?op ?e1 ?e2 (Val ?v3)      => add_item (TernOp2Ctx op e1 v3) vs K e2
    | TernOp ?op ?e1 ?e2 ?e3            => add_item (TernOp3Ctx op e1 e2) vs K e3
    ...
    | Box ?e                          => add_item BoxCtx vs K e
    | Unbox ?e                        => add_item UnboxCtx vs K e
    ...
    | Hash ?e                         => add_item HashCtx vs K e
    end
