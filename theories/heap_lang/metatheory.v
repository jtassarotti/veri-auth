...
Fixpoint subst_map (vs : gmap string val) (e : expr) : expr :=
  ...
  | TernOp op e1 e2 e3 => TernOp op (subst_map vs e1) (subst_map vs e2) (subst_map vs e3)
...
Lemma bin_op_eval_closed op v1 v2 v' :
  ...
  is_closed_val v'.
Proof.
  rewrite /bin_op_eval /bin_op_eval_bool /bin_op_eval_int /bin_op_eval_loc /bin_op_eval_string;
    repeat case_match; naive_solver.
Qed.

Lemma tern_op_eval_closed op v1 v2 v3 v' :
  is_closed_val v1 → is_closed_val v2 → is_closed_val v3 →
  tern_op_eval op v1 v2 v3 = Some v' →
  is_closed_val v'.
Proof.
  rewrite /tern_op_eval /option_nat_to_val; repeat case_match; by naive_solver.
Qed.
...
Proof.
  ...
  - eapply tern_op_eval_closed; eauto; naive_solver.
