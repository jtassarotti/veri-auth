...
Section compatibility.
  ...
  Proof.
    iIntros "IH1 IH2" (????) "Hv Hi Htok".
    rel_bind_ap e2 e2' e2'' "IH2" v1 v2 v3 "(Hw & Hi & HB & Htok)".
    rel_bind_ap e1 e1' e1'' "IH1" w1 w2 w3 "(Hw & Hi & HA & Htok)".
    value_case.
  ...
  Proof.
    iIntros "IH1 IH2" (????) "Hv Hi Htok".
    rel_bind_ap e2 e2' e2'' "IH2" v v' v'' "(Hv & Hi & HA & Htok)".
    rel_bind_ap e1 e1' e1'' "IH1" f f' f'' "(Hv & Hi & HAB & Htok)".
    iApply ("HAB" with "HA Hv Hi Htok").
  Qed.
  ...
  Proof.
    iIntros "IH1 IH2" (????) "Hv Hi Htok".
    rel_bind_ap e1 e1' e1'' "IH1" v v' v'' "(Hv & Hi &Hvv & Htok)".
  ...
  Proof.
    iIntros "#H" (????) "Hv Hi Htok".
    wp_pures.
    iFrame.
    iIntros "!#" (a ?) "!#".
    iIntros (??) "_". iIntros (????) "Hv Hi Htok".
    v_pures; i_pures; wp_pures.
    iApply ("H" with "[$] [$] [$]").
  Qed.
  ...
  Proof.
    iIntros "IH1 IH2" (Kₚ tₚ Kᵢ tᵢ) "Hv Hi Htok".
    rel_bind_ap e2 e2' e2'' "IH2" w w' w'' "(Hv & Hi & #HAw & Htok)".
    rel_bind_ap e1 e1' e1'' "IH1" v v' v'' "(Hv & Hi & #Hr & Htok)".
  ...
  Lemma refines_load e e' e'' A :
    ...
    REL !e << !e' << !e'' : A.
  Proof.
    iIntros "IH" (????) "Hv Hi Htok".
    rel_bind_ap e e' e'' "IH" v v' v'' "(Hv & Hi & #Hr & Htok)".
