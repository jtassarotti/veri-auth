...
(** ** bind *)
Lemma tac_v_bind_gen `{authG Σ, seqG Σ} k Δ Δ' i p e e' Q :
...
Lemma tac_v_bind `{authG Σ, seqG Σ} k e' Δ Δ' i p K' e Q :
  envs_lookup i Δ = Some (p, spec_verifier k e)%I →
  e = fill K' e' →
...
Lemma tac_v_pure `{authG Σ, seqG Σ} e K' e1 k e2 Δ1 E1 i1 e' ϕ ψ Q n :
...
Lemma tac_v_store `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e (l : loc) e' e2 v' v Q :
...
Lemma tac_v_xchg `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e (l : loc) e' e2 v' v Q :
  envs_lookup_delete false i1 Δ1 = Some (false, spec_verifier k e, Δ2)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (Xchg (# l) e') →
...
Lemma tac_v_load `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e e2 (l : loc) v Q q :
  envs_lookup_delete false i1 Δ1 = Some (false, spec_verifier k e, Δ2)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (Load #l) →
...
Lemma tac_v_cmpxchg_fail `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e enew (l : loc) e1 e2 v' v1 v2 Q q :
  envs_lookup_delete false i1 Δ1 = Some (false, spec_verifier k e, Δ2)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
...
Lemma tac_v_cmpxchg_suc `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e enew (l : loc) e1 e2 v' v1 v2 Q :
  envs_lookup_delete false i1 Δ1 = Some (false, spec_verifier k e, Δ2)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (CmpXchg #l e1 e2) →
...
Lemma tac_v_faa `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e enew (l : loc)  e2 (z1 z2 : Z) Q :
  envs_lookup_delete false i1 Δ1 = Some (false, spec_verifier k e, Δ2)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (FAA #l e2) →
...
Lemma tac_v_fork `{authG Σ, seqG Σ} k Δ1 E1 i1 K' e enew e' Q :
  envs_lookup i1 Δ1 = Some (false, spec_verifier k e)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (Fork e') →
...
Lemma tac_v_alloc `{authG Σ, seqG Σ} k Δ1 E1 i1 K' e e' v Q :
  envs_lookup i1 Δ1 = Some (false, spec_verifier k e)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (ref e') →
...
(** ** bind *)
Lemma tac_i_bind_gen `{authG Σ, seqG Σ} k Δ Δ' i p e e' Q :
...
Lemma tac_i_bind `{authG Σ, seqG Σ} k e' Δ Δ' i p K' e Q :
  envs_lookup i Δ = Some (p, spec_ideal k e)%I →
  e = fill K' e' →
...
Tactic Notation "i_bind" open_constr(efoc) :=
  i_bind _ efoc.
Lemma tac_i_pure `{authG Σ, seqG Σ} e K' e1 k e2 Δ1 E1 i1 e' ϕ ψ Q n :
  (* we have those premises first, because we will be trying to solve them *)
(*      with backtracking using reashape_expr; see the accompanying Ltac. *)
(*      the first premise decomposes the expression, the second one checks *)
(*      that we can make a pure step *)
...
Lemma tac_i_store `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e (l : loc) e' e2 v' v Q :
...
Lemma tac_i_xchg `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e (l : loc) e' e2 v' v Q :
  envs_lookup_delete false i1 Δ1 = Some (false, spec_ideal k e, Δ2)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (Xchg (# l) e') →
...
Lemma tac_i_load `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e e2 (l : loc) v Q q :
  envs_lookup_delete false i1 Δ1 = Some (false, spec_ideal k e, Δ2)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (Load #l) →
...
Lemma tac_i_cmpxchg_fail `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e enew (l : loc) e1 e2 v' v1 v2 Q q :
  envs_lookup_delete false i1 Δ1 = Some (false, spec_ideal k e, Δ2)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (CmpXchg #l e1 e2) →
...
Lemma tac_i_cmpxchg_suc `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e enew (l : loc) e1 e2 v' v1 v2 Q :
  envs_lookup_delete false i1 Δ1 = Some (false, spec_ideal k e, Δ2)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (CmpXchg #l e1 e2) →
...
Lemma tac_i_faa `{authG Σ, seqG Σ} k Δ1 Δ2 E1 i1 i2 K' e enew (l : loc)  e2 (z1 z2 : Z) Q :
  envs_lookup_delete false i1 Δ1 = Some (false, spec_ideal k e, Δ2)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (FAA #l e2) →
...
Lemma tac_i_fork `{authG Σ, seqG Σ} k Δ1 E1 i1 K' e enew e' Q :
  envs_lookup i1 Δ1 = Some (false, spec_ideal k e)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (Fork e') →
...
Lemma tac_i_alloc `{authG Σ, seqG Σ} k Δ1 E1 i1 K' e e' v Q :
  envs_lookup i1 Δ1 = Some (false, spec_ideal k e)%I →
  (∀ P, ElimModal True false false (|={E1}=> P) P Q Q) →
  nclose specN ⊆ E1 →
  e = fill K' (ref e') →
