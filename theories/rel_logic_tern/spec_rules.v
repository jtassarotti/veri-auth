...
From auth.rel_logic_tern Require Export model.
Import uPred.
...
Lemma gwp_mixin_spec_verifier `{!authG Σ} :
...
Canonical Structure gwp_spec_verifier `{!authG Σ} := Build_GenWp gwp_mixin_spec_verifier.
