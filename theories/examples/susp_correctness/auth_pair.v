...
Section authenticatable.
  ...
  Proof.
    ...
    - (* 3. suspend_v_deser_spec (combined) *)
      iIntros "!#" (t' a1 un_a1 a2 a3 s_def s_pred K tᵥ3 pid m vm d ps pn ctr gm mlg mlg_p) "Hv".
      v_pures.
      (* HeapLang evaluation: argument first. Bind v_dB before v_dA. *)
      v_bind tᵥ3 (v_dB #pid).
      iMod ("HsuspvdeserB" $! _ _ _ _ _ _ _ _ _ pid _ _ _ _ _ _ _ _ _ with "Hv")
        as (v_deser_par_B) "[Hv #Hsuspvdeser_inner_B] /=".
      v_bind tᵥ3 (v_dA #pid).
      iMod ("HsuspvdeserA" $! _ _ _ _ _ _ _ _ _ pid _ _ _ _ _ _ _ _ _ with "Hv")
