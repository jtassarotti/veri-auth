(* This implements a prover that uses the authenticatable_marshal_fcmod 
   functions. This does not appear in the paper, or in our proofs, and is 
...
module Prover_marshal : sig
  ...
  let[@inline] auth (type a') (evi: a' evidence) (a: a') =
    ...
    (a, hash (Evi.serialize (Evi.prepare a)))
