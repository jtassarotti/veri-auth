(* Another way to use the OCaml Marshal serialization library. This differs from
   authenticatable_marshal.ml in the way it implements existential types - using
   first-class modules. *)
